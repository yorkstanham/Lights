...
class Demo1:
    def __init__(self, master):
        ...
        self.start_controller_one = tk.Button(self.frame, text='Connect Remotes', command=self.break_timer_manager)
        self.e = Entry(self.frame,justify='center')
        self.e.insert(0, '00:03:01')
    ...
    def init_break_timer(self):
        ...
        self.home_canvas.delete("submission_text")
        self.home_canvas.delete("countdown_time_for_submission_one")
        ...
        self.home_canvas.create_text(self.x_centre, self.y_centre, fill="white", font=self.timerFont, text="10:00", tag="breakTimer")
        self.break_timer()
    ...
    def break_timer(self):
        ...
        if self.hours_left > 0:
            self.home_canvas.create_text(self.x_centre, self.y_centre, fill=self.text_colour, font=self.timerFont, text=(str(self.hours_left) + ":" + str(self.minutes_left) + ":" + str(self.seconds_left)), tag="breakTimer")
        elif self.hours_left == 0:
            self.home_canvas.create_text(self.x_centre, self.y_centre, fill=self.text_colour, font=self.timerFont, text=(str(self.minutes_left) + ":" + str(self.seconds_left)), tag="breakTimer")
        ...
        ''' if self.continue_break_timer:
            ...
            if self.seconds_for_timer == 58 and self.minutes_for_timer == 59 and self.hours_for_timer == -1:
                ...
                self.home_canvas.after(999,self.break_timer)'''
